...
return [
     ...
     */
    'enums' => [
        'currency' => \Vinalask3\LaravelVirtualWallet\Tests\Enums\CurrencyEnum::class,
        'currency_type' => \Vinalask3\LaravelVirtualWallet\Tests\Enums\CurrencyTypeEnum::class,
        'transaction_method' => \Vinalask3\LaravelVirtualWallet\Tests\Enums\TransactionMethodEnum::class,
        'transaction_status' => \Vinalask3\LaravelVirtualWallet\Tests\Enums\TransactionStatusEnum::class,
        'transaction_type' => \Vinalask3\LaravelVirtualWallet\Tests\Enums\TransactionTypeEnum::class,
        'wallet_status' => \Vinalask3\LaravelVirtualWallet\Tests\Enums\WalletStatusEnum::class,
        'wallet_type' => \Vinalask3\LaravelVirtualWallet\Tests\Enums\WalletTypeEnum::class,
    ],
